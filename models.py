...
class Actor(nn.Module):
    def __init__(self, num_states, num_actions, hidden1_dims=400, hidden2_dims=300, init_w=3e-3, chkpt_dir='./models', name="no_name_actor"):
...
class Critic(nn.Module):
    ...
    def __init__(self, num_states, num_actions, hidden1_dims=400, hidden2_dims=300, init_w=3e-3, chkpt_dir='./models', name="no_name_critic"):
