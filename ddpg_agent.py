...
class DDPGAgent(object):
    def __init__(self, num_states, tau, gamma=0.99,
                 num_actions=2, max_size=1000000, hidden1_dims=400,
        ...
        self.target_actor = Actor(num_states, num_actions, hidden1_dims, hidden2_dims, name='Target_Actor')
        self.actor_optim  = Adam(self.actor.parameters(), lr=self.actor_lr)

        ### Critic Networks ###
        self.critic = Critic(num_states, num_actions, hidden1_dims, hidden2_dims, name='Critic')
        self.target_critic = Critic(num_states, num_actions, hidden1_dims, hidden2_dims, name='Target_Critic')
        self.critic_optim  = Adam(self.critic.parameters(), lr=self.critic_lr)


        self.noise = OUActionNoise(mu=np.zeros(num_actions))
        self.memory = ReplayBuffer(max_size, num_states, num_actions)
